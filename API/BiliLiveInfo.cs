...
namespace BiliAPI
{
    class BiliLiveInfo
    {
        ...
        public BiliLiveInfo(long roomId)
        {
            RoomId = roomId;
        }
            ...
            try
            {
                ...
                if (match.Success)
                    return new Info()
                    {
                        ...
                        Attention = long.Parse(match.Groups["Attention"].Value),
                        Online = long.Parse(match.Groups["Online"].Value),
                        LiveStatus = long.Parse(match.Groups["LiveStatus"].Value)
                    };
                return null;
            }
            catch (WebException)
